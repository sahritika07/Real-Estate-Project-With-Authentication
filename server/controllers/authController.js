...
import { EMAIL_VERIFY_TEMPLATE, PASSWORD_RESET_TEMPLATE, ACCOUNT_REGISTERED_TEMPLATE} from '../config/emailTemplates.js';
...
export const register = async (req,res)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            html: ACCOUNT_REGISTERED_TEMPLATE.replace("{{email}}",user.email)
        }
