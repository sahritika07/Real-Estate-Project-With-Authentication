...
const Projects = () => {
  ...
  return (
    <motion.div initial={{opacity:0 , x:-200}}
      ...
      viewport={{once: true}} className='container mx-auto py-4 pt-12 px-6 md:px-20 lg:px-32 my-20 overflow-hidden' id="Projects">
      ...
      <p className='text-center text-gray-500 mb-3 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Portfolio</p>
